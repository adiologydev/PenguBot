...
module.exports = class InsultCMD extends Command {
    ...
    constructor(client) {
        super(client, {
            ...
            group: "fun",
            memberName: "insult",
            description: "Insults a person mentioned.",
            usage: ["<prefix>insult <user:mention>"],
            throttling: {
                usages: 1,
                duration: 3
            },
            args: [{
                key: "user",
                prompt: "Mention a user who I should insult.",
                type: "user"
            }],
            guildOnly: true
        });
