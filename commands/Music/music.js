...
module.exports = class extends Command {
    ...
    async run(msg) {
        ...
        const embed = new MessageEmbed()
            ...
            .addField("\u200B", `**Support PenguBot, Become a Patron**\nWant to get access to exclusive features while supporting PenguBot? Consider becoming a Patron today: [Patreon](https://www.patreon.com/PenguBot)\n\n**Note:** This feature does go through constant development mostly all the time. If you have bugs, please report them on our support server \`${prefix}invite\` for link.`); // eslint-disable-line max-len
