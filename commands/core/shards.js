...
module.exports = class ShardsCommand extends Command {
    ...
    async run(msg) {
        ...
        const evalstr = `[this.shard.id, this.guilds.size, this.channels.size, this.users.size, (process.memoryUsage().heapTotal / 1024 / 1024).toFixed(2), this.player.size, this.uptime]`;
