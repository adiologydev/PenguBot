...
module.exports = class StatsCMD extends Command {
    ...
    async run(msg) {
        ...
        const v = await this.client.shard.fetchClientValues("voiceConnections.size");
        ...
        const botstats = new Discord.RichEmbed()
            ...
            .setColor("#264d90")
            .setFooter("(C) PenguBot", this.client.user.avatarURL)
            .setTimestamp()
            .addField("Guilds", num, true)
            .addField("Users", users, true)
            .addField("Memory Usage", `${mem} MB`, true)
            .addField("Voice Streams", voiceConnections, true)
            ...
            .addField("Join PenguBot's Support Guild", "[**discord.gg/u8WYw5r**](https://discord.gg/u8WYw5r)", true);
