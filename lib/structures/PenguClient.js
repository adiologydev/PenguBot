...
class PenguClient extends Client {
    ...
    constructor(options) {
        ...
        this.prometheusActions = {
            guildGauge: new promClient.Gauge({ name: "guild_count", help: "A metric for storing Pengus guild count" }),
            commandCounter: new promClient.Counter({ name: "command_count", help: "A counter to display the number of used commands" })
        };
    }
