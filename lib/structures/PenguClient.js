...
const PenguConsole = require("./Console.js");
...
class PenguClient extends Client {
    ...
    constructor(options) {
        ...
        this.console = new PenguConsole(this);
        this.rest = new RESTManager(this, this.options._tokenType);
        this.IPC = new Node(`PenguBot${this.shard.id}`)
            .on("connect", name => this.console.connectionOpen(`Connected to: ${name}`));
        ...
        this.IPC.connectTo("PenguManager", 9999)
            .catch(() => this.console.connectionClose("Disconnected from: PenguManager"));
    }
