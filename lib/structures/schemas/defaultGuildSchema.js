...
module.exports = KlasaClient.defaultGuildSchema
    ...
    .add("automod", folder => folder
        ...
        .add("filters", filter => filter
            .add("TOXICITY", "any", { default: { enabled: false, threshold: 0.93 } })
            .add("SEVERE_TOXICITY", "any", { default: { enabled: false, threshold: 0.93 } })
            .add("THREAT", "any", { default: { enabled: false, threshold: 0.93 } })
            .add("SPAM", "any", { default: { enabled: true, threshold: 0.70 } })
            .add("OBSCENE", "any", { default: { enabled: false, threshold: 0.93 } })
            .add("SEXUALLY_EXPLICIT", "any", { default: { enabled: false, threshold: 0.93 } })
            .add("PROFANITY", "any", { default: { enabled: false, threshold: 0.93 } }))
